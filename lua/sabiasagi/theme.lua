...
M.loadSyntax = function()
	...
	local syntax = {
		...
		Conditional = { fg = colors.color4, bg = colors.none, style = "italic" },
		Function = { fg = colors.color6, bg = colors.none, style = "italic" },
		Identifier = { fg = colors.color4, bg = colors.none, style = "italic" },
		Keyword = { fg = colors.color4, bg = colors.none, style = "italic" },
		Repeat = { fg = colors.color4, bg = colors.none, style = "italic" },
		...
		-- 置換対象語句
		Substitute = { fg = colors.shade0, bg = colors.color3, style = "italic" },
	}
...
M.loadEditor = function()
	...
	local editor = {
		...
		SpellLocal = { fg = colors.color6, bg = colors.none, style = "italic,undercurl" },
		SpellRare = { fg = colors.color4, bg = colors.none, style = "italic,undercurl" },
		...
		TablineSel = { fg = colors.shade1, bg = colors.color4 },
		...
		VisualMode = { fg = colors.color4, bg = colors.none, style = "reverse" },
...
M.loadTreeSitter = function()
	...
	local treesitter = {
		...
		["@punctuation.delimiter"] = { fg = colors.color6 },
		["@punctuation.bracket"] = { fg = colors.color6 },
		["@punctuation.special"] = { fg = colors.color6 },
		...
		TSBoolean = { fg = colors.color4, style = "bold" },
		...
		["@boolean"] = { fg = colors.color4, style = "bold" },
		...
		TSConditional = { fg = colors.color4, style = "italic" },
		TSFunction = { fg = colors.color6, style = "italic" },
		TSMethod = { fg = colors.color14, style = "italic" },
		TSFuncBuiltin = { fg = colors.color6, style = "italic" },
		TSNamespace = { fg = colors.shade5, style = "italic" },
		TSField = { fg = colors.shade5, style = "italic" },
		TSProperty = { fg = colors.color15, style = "italic" },
		TSKeyword = { fg = colors.color4, style = "italic" },
		TSKeywordFunction = { fg = colors.color6, style = "italic" },
		TSKeywordReturn = { fg = colors.color6, style = "italic" },
		TSKeywordOperator = { fg = colors.color6, style = "italic" },
		TSRepeat = { fg = colors.color4, style = "italic" },
		...
		["@conditional"] = { fg = colors.color4, style = "italic" },
		["@function"] = { fg = colors.color6, style = "italic" },
		["@method"] = { fg = colors.color6, style = "italic" },
		["@function.builtin"] = { fg = colors.color6, style = "italic" },
		["@namespace"] = { fg = colors.shade5, style = "italic" },
		["@field"] = { fg = colors.shade5, style = "italic" },
		["@property"] = { fg = colors.color15, style = "italic" },
		["@keyword"] = { fg = colors.color4, style = "italic" },
		["@keyword.function"] = { fg = colors.color6, style = "italic" },
		["@keyword.return"] = { fg = colors.color6, style = "italic" },
		["@keyword.operator"] = { fg = colors.color6, style = "italic" },
		["@repeat"] = { fg = colors.color4, style = "italic" },
...
M.loadLSP = function()
	local lsp = {
		...
		LspDiagnosticsDefaultHint = { fg = colors.color4 },
		LspDiagnosticsSignHint = { fg = colors.color4 },
		LspDiagnosticsFloatingHint = { fg = colors.color4 },
		LspDiagnosticsVirtualTextHint = { fg = colors.color4 },
...
M.loadPlugins = function()
	local plugins = {
		...
		HopNextKey1 = { fg = colors.color6, style = "bold" },
		...
		LspTroubleCount = { fg = colors.color4, bg = colors.color15 },
