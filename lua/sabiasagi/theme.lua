...
M.loadEditor = function()
	...
	local editor = {
		...
		ColorColumn = { fg = colors.none, bg = colors.background },
		...
		SignColumn = { fg = colors.background, bg = colors.none },
		...
		StatusLineNC = { fg = colors.shade5, bg = colors.background },
		StatusLineTerm = { fg = colors.shade5, bg = colors.shade2 },
		StatusLineTermNC = { fg = colors.shade5, bg = colors.background },
		TabLineFill = { fg = colors.shade5, bg = colors.none },
		TablineSel = { fg = colors.shade1, bg = colors.color6 },
		Tabline = { fg = colors.shade5, bg = colors.background },
		...
		ToolbarLine = { fg = colors.shade5, bg = colors.background },
...
M.loadLSP = function()
	local lsp = {
		...
		LspReferenceText = { fg = colors.shade5, bg = colors.background },
		LspReferenceRead = { fg = colors.shade5, bg = colors.background },
		LspReferenceWrite = { fg = colors.shade5, bg = colors.background },
