...
local setting = {
	fill = colors.background, -- 全体の背景
	indicator = colors.background, -- インジケーターの色
	bg = colors.background, -- 非アクティブなbufferのタブ
	buffer_bg = colors.shade6, -- diagnostic
	buffer_bg_selected = colors.shade, -- アクティブなbufferのタブ
	buffer_bg_visible = colors.background, -- 開かれているが非アクティブなbufferのタブ
	bold = true,
	italic = true,
}
